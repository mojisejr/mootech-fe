...
MUT=[
 ("MU1 create's gender label says ของคุณ again", 'features/v2-service/components/AddFriendSheet.tsx',
  "            <Label>เพศดั้งเดิมของเพื่อน</Label>", "            <Label>{edit ? 'เพศดั้งเดิมของเพื่อน' : 'เพศดั้งเดิมของคุณ'}</Label>"),
 ("MU2 the name placeholder says ของคุณ again", 'features/v2-service/components/AddFriendSheet.tsx',
  'placeholder="ใส่ชื่อเพื่อน"', 'placeholder="ใส่ชื่อของคุณ"'),
 ("MU3 create and edit word the name field differently", 'features/v2-service/components/AddFriendSheet.tsx',
  "            <Label>ชื่อเพื่อน</Label>", "            <Label>{edit ? 'ชื่อเพื่อน' : 'ชื่อ'}</Label>"),
 ("MU4 blanket-replace ของคุณ, breaking the correct save-error line", 'features/v2-service/components/AddFriendSheet.tsx',
  "'ไม่ใช่ข้อมูลของคุณผิด ลองอีกครั้งได้เลย'", "'ไม่ใช่ข้อมูลของเพื่อนผิด ลองอีกครั้งได้เลย'"),
]

def failed_tests():
    r=subprocess.run(['npx','vitest','run','scripts/add-friend-copy.test.tsx','scripts/edit-friend-ui.test.tsx','--reporter=json'],
