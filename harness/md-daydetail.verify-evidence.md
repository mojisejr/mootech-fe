...
**3 รูปแบบทิศในระบบเดียว**: `gates="NE"` · `lucky_dir="ทิศ SE"` · `fixture="ทิศตะวันออกเฉียงเหนือ"`
⇒ parser รับทั้งสาม · **อะไรที่อ่านไม่ออก โผล่เป็นกล่องเตือน ไม่หายเงียบ** — ตัวที่หายเงียบคือตัวที่ฆ่าเรา
