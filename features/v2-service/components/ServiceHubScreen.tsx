...
// PRESENTATIONAL, zero logic: header chrome + 12 catalog cards + the shared bottom Menubar. No fetch,
// no state, no auth beyond the page-level v2 gate. The whole surface is UI-only — มุนใบเดียวจบ.
//
