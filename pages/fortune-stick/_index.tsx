...
export default function FortuneStickPage() {
  ...
  const onSubmit = async () => {
    ...
    const result = await HeavenSpiritCardGet(userId)
            ...
            <div className='w-fit relative'>
                <div className='w-fit flex flex-wrap'>
                  ...
                  <div className='w-fit absolute bottom-0 left-1/2 -translate-x-1/2 z-40 mb-6 mb:mb-24 flex'>
                    <button
                      onClick={() => { onSubmit() }}
                      className={ ( isDisable ? ' bg-gray-200  ' : ' bg-moumate_blue cursor-pointer ') + " w-full rounded-[16px] py-[16px] px-[16px]  shadow-md text-white justify-center"}
                    >
          ...
          <div className='w-full flex flex-wrap fixed top-0 left-0 z-50  justify-center h-full  overflow-y-auto'>
              <div className='w-full lg:w-[600px] bg-white  rounded-t-[48px] py-6 px-4  animate-slide-up'>
                ...
                <div className='w-full flex flex-wrap'>
                  ...
                  <span className='w-full text-moumate_blue text-2xl flex justify-center text-center font-medium'>คำทำนายเซียมซี<br/>ใบที่ {fortuneInfo?.no}</span>

                </div>

                <div className='w-full flex justify-center'>
                  <div className='w-[220px] h-[300px] relative mt-5'>
                    <Image
                ...
                <div className='w-full flex flex-wrap mt-0 lg:mt-4'>
                    ...
                    <div className='w-full flex flex-wrap justify-center  mt-4 lg:mt-0'>
                      ...
                      <button
                        disabled={isDisable}
                        onClick={ () => { onSubmit() }}
                        className={ ( isDisable ? '  bg-gray-200 ' : ' bg-[#1455A4]  cursor-pointer ') + " w-full md:w-[250px] h-[60px]  rounded-[16px] py-[16px] px-[16px]  shadow-md text-white justify-center"}>
