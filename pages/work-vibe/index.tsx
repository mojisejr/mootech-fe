...
import { CompatibilityWorkGet } from "@/constants/api/api-compatibility-work";
...
export default function WorkVibePage() {
 ...
 const gotoBack = () => {
       ...
       <div className="  w-full flex flex-wrap px-4 ">
                        ...
                        <div className="w-full flex justify-center flex-wrap">
                              ...
                              <Image
                                className=""
                                alt="mootech-icon"
                                src={'/images/mumate/ic_work_topic.svg'}
                                width={250}
                                height={80}
                              />
                            </div>
                        ...
                        <div className="w-full flex flex-wrap justify-center text-center mt-4">
                          <span className="w-full  justify-center flex font-semibold text-[36px] text-moumate_blue">มาเช็คดวงการทำงานกัน (Work Vibe)</span>
                          <span className=" w-full justify-center flex mt-1 text-[18px] text-moumate_gray">เช็คดวงการทำงานกับคนในออฟฟิศ รู้ไว้จัดการได้ ทำงานกับใครง่าย ใครยาก ใครต้องระวัง</span>
                     ...
                     {/* Name input */}
                            <div className="w-full flex flex-wrap ">
                              ...
                              <div className="w-full flex flex-wrap">
                                ...
                                >
                                    <option key={'FRIEND'} value={'FRIEND'}>หุ้นส่วน / เพื่อนร่วมงาน</option>
                                    <option key={'BOSS'} value={'BOSS'}>เจ้านาย</option>
                                    <option key={'EMPLOYEE'} value={'EMPLOYEE'}>ลูกน้อง</option>
              ...
              <div className=" w-full justify-center flex flex-wrap">
                <div className={
                    ...
                    <div className="w-full flex flex-wrap justify-center mt-4">
                        <span className="w-full flex justify-center text-moumate_blue font-bold text-[32px]">ดวงการทำงานกัน</span>
                ...
                <div className={
                  ...
                  <span className="w-full flex justify-center text-moumate_blue text-[24px] font-semibold">ของเสริมงาน</span>
  ...
  const onSubmit = async () =>{
    ...
    const resultCheck = await callApiCheckWork()
    ...
    const result = await CompatibilityWorkGet(
      userId,
      `${displayName} ${displaySurname} `, myDob, myTime, myGender,
      name, youDob, youTime, gender, type
    )
  ...
  return (
    ...
    <Head>
      ...
      className="w-full flex flex-wrap"> 
          ...
          <div 
            className="w-full  min-h-full  justify-center pt-[72px] lg:pt-[72px] mt-0 lg:mt-4">
              {
                getUI()
              }
          </div>
