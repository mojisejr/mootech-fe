...
describe('#363 the screen cannot contradict the table', () => {
  it('🔴 the success mark appears on exactly the states where money moved — all twelve checked', () => {
    expect(STATES).toHaveLength(12) // #455 QR_EXPIRED · #484 PAYMENT_REVERSED · #492 PAYMENT_SETUP_BROKEN joined the table
